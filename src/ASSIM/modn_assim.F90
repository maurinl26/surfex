...
USE MODD_ASSIM, ONLY:  LASSIM,CASSIM,CASSIM_ISBA,NPRINTLEV,LAROME,LECSST,LAESST,LAESNM,LWATERTG2, &
                       ...
                       LBIAS_CORRECTION, LCROCO, CPF_CROCUS, NEFF_PF, XDLOC_PF, LLOO_PF,          &
                       XERROBS_FACTOR_M, XTAUSCF, XCEILSCF
!
IMPLICIT NONE
!
NAMELIST/NAM_ASSIM/LASSIM,CASSIM,CASSIM_ISBA,NPRINTLEV,LAROME,LECSST,LAESST,LAESNM,LALADSURF,    &
                   ...
                   LCROCO, CPF_CROCUS, NEFF_PF, XDLOC_PF, LLOO_PF
...
NAMELIST/NAM_OBS/NOBSTYPE,LOBSHEADER,CFILE_FORMAT_OBS, LOBSNAT, COBS_M, XERROBS_M, XERROBS_FACTOR_M, NNCO
NAMELIST/NAM_VAR/NIVAR, NVAR, CVAR_M, CPREFIX_M, XSIGMA_M, XTPRT_M, NNCV, XSCALE_Q, XSCALE_QLAI, &
                 CBIO, CPREFIX_BIO, XALPH, XTAUSCF, XCEILSCF
