...
YATT_TITLE(1) = 'units'
IF (LSPLIT_NC) THEN
  CALL WRITE_NETCDF_FORC(IFILE_ID(2),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(3),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(4),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(5),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(6),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(7),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(8),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(9),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(10),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(11),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
  CALL WRITE_NETCDF_FORC(IFILE_ID(12),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
ELSE
  CALL WRITE_NETCDF_FORC(IFILE_ID(1),'time','',ZTIME(:),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
ENDIF
!
ZTSTEPFRC4 = ZTSTEPFRC
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'FRC_TIME_STP','Forcing_Time_Step',ZTSTEPFRC4)
!
ZLON4(:) = ZLON(:)
ZLAT4(:) = ZLAT(:)
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'LON','Longitude', ZLON4, IDDIM(1))
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'LAT','Latitude', ZLAT4, IDDIM(1))
!
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'ZS','Surface_Orography',ZZS, IDDIM(1))
!
YATT_TITLE(1)='units'
YATT(1) = 'm'
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'ZREF','Reference_Height',ZZREF,IDDIM(1),YATT_TITLE(1:1),YATT(1:1))
CALL WRITE_NETCDF_FORC(IFILE_ID(1),'UREF','Reference_Height_for_Wind',ZUREF,IDDIM(1),YATT_TITLE(1:1),YATT(1:1))
!
...
!
YATT      (2) = 'K'
CALL WRITE_NETCDF_FORC(IFILE_ID(2),'Tair','Near_Surface_Air_Temperature',TRANSPOSE(ZTA(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:2),YATT(1:2))
!
YATT      (2) = 'Kg/Kg'
CALL WRITE_NETCDF_FORC(IFILE_ID(3),'Qair','Near_Surface_Specific_Humidity',TRANSPOSE(ZQA(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:2),YATT(1:2))
!
YATT(1) = 'Pa'
CALL WRITE_NETCDF_FORC(IFILE_ID(4),'PSurf','Surface_Pressure',TRANSPOSE(ZPS(JNPTS1:JNPTS2,:)),&
...
!
YATT(1) = 'W/m2'
CALL WRITE_NETCDF_FORC(IFILE_ID(5),'DIR_SWdown','Surface_Indicent_Direct_Shortwave_Radiation' ,&
        TRANSPOSE(ZDIR_SW(JNPTS1:JNPTS2,:)),IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT(1) = 'W/m2'
CALL WRITE_NETCDF_FORC(IFILE_ID(6),'SCA_SWdown','Surface_Incident_Diffuse_Shortwave_Radiation' ,&
        TRANSPOSE(ZSCA_SW(JNPTS1:JNPTS2,:)),IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT(1) = 'W/m2'
CALL WRITE_NETCDF_FORC(IFILE_ID(7),'LWdown','Surface_Incident_Longwave_Radiation' ,&
        TRANSPOSE(ZLW(JNPTS1:JNPTS2,:)),IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT(1) = 'Kg/m2/s'
CALL WRITE_NETCDF_FORC(IFILE_ID(8),'Rainf','Rainfall_Rate',TRANSPOSE(ZRAIN(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT(1) = 'Kg/m2/s'
CALL WRITE_NETCDF_FORC(IFILE_ID(9),'Snowf','Snowfall_Rate',TRANSPOSE(ZSNOW(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT      (2) = 'm/s'
CALL WRITE_NETCDF_FORC(IFILE_ID(10),'Wind','Wind_Speed',TRANSPOSE(ZWINDSPEED(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:2),YATT(1:2))
!
YATT(1) = 'deg'
CALL WRITE_NETCDF_FORC(IFILE_ID(11),'Wind_DIR','Wind_Direction',TRANSPOSE(ZWINDDIR(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
YATT(1) = 'Kg/m3'
CALL WRITE_NETCDF_FORC(IFILE_ID(12),'CO2air','Near_Surface_CO2_Concentration',TRANSPOSE(ZCO2(JNPTS1:JNPTS2,:)),&
        IDDIM(1),IDDIM(2),YATT_TITLE(1:1),YATT(1:1))
!
!              2.4 closing file
!     ------------
