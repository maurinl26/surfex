...
!
USE MODD_TOPODYN, ONLY       : CCAT, XSPEEDR, XSPEEDG, XSPEEDH,LSPEEDR_VAR,&
                               XQINIT, XRTOP_D2
USE MODD_COUPLING_TOPD, ONLY : LCOUPL_TOPD, NNB_TOPD,LBUDGET_TOPD, LSTOCK_TOPD,&
                               NNB_STP_STOCK, NNB_STP_RESTART,NFREQ_MAPS_WG, &
                               NFREQ_MAPS_ASAT,NFREQ_MAPS_RUNOFF, &
                               LDUMMY_SUBCAT,LSUBCAT,NSUBCAT,XLX,XLY,&
                               CSUBCAT,CFILE_SUBCAT, &
                               LPERT_PARAM, LPERT_INIT, LWRITE_SEVERITY_MAPS
!
...
IF (LCOUPL_TOPD) &
  CALL READ_NAM_TOPD(HPROGRAM,LBUDGET_TOPD,NNB_TOPD,&
                     ...
                     XSPEEDR,XSPEEDG,XSPEEDH,LSPEEDR_VAR,XQINIT,XRTOP_D2,&
