...
$(ECCODES_MOD $(ECCODES_MOD))
ifeq "$(VER_ECCODES)" "ECCODESCTI"
DIR_ECCODES_INSTALL=/usr
INC_ECCODES   ?= -I${DIR_ECCODES_INSTALL}/include/x86_64-linux-gnu -I/usr/lib/x86_64-linux-gnu/fortran/gfortran-mod-15/
LIB_ECCODES   ?= -L${DIR_ECCODES_INSTALL}/lib/x86_64-linux-gnu -L${DIR_ECCODES_INSTALL}/lib64/x86_64-linux-gnu -leccodes_f90 -leccodes -Wl,-rpath,${DIR_ECCODES_INSTALL}/lib/x86_64-linux-gnu
endif
$(ECCODES_MOD $(ECCODES_MOD))
