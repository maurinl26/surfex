...
!!             - remove opening in writing case (limited to INIT_OUTPUT_NC_n)
!!=================================================================
!
!*       0.   DECLARATIONS
!             ------------
...
USE MODD_IO_SURF_NC, ONLY : NMASK, CFILEIN_NC, CFILEOUT_NC, LMASK, NID_NC, NID_NCOUT, &
                            CMASK, LDEF, CFILE_NC, NFULL
...
IF (HACTION=='READ ') THEN
  ...
  IF (GEXIST) THEN 
    ...
    IF (IRET.NE.NF90_NOERR) CALL HANDLE_ERR(IRET,'INIT_IO_SURF_NC_n')
