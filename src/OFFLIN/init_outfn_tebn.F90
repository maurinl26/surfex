...
!
 ...
 CALL OL_DEFINE_DIM(UG, U%NSIZE_FULL, HPROGRAM, KLUOUT, INI, &
                    GDM%NPE%AL(1)%TSNOW, IDIM1, YUNIT1, YUNIT2, &
                    ZX, ZY, IDIMS, IDDIM, YNAME_DIM,.FALSE., .FALSE., PLAT=ZLAT,PLON=ZLON)
...
!
 CALL OL_DEFINE_DIM(UG, U%NSIZE_FULL, HPROGRAM, KLUOUT, INI, &
                    GDM%NPE%AL(1)%TSNOW,IDIM1, YUNIT1, YUNIT2, &
                    ZX, ZY, IDIMS, IDDIM, YNAME_DIM, .FALSE., .FALSE., KNSNLAYER=1)
!
...
IF (TM%TOP%LGARDEN) THEN
  ...
  CALL OL_DEFINE_DIM(UG, U%NSIZE_FULL, HPROGRAM, KLUOUT, INI,  &
                     GDM%NPE%AL(1)%TSNOW, IDIM1, YUNIT1, YUNIT2, &
                     ZX, ZY, IDIMS, IDDIM, YNAME_DIM, .FALSE., .FALSE., &
                     KNSNLAYER=GDM%NPE%AL(1)%TSNOW%NLAYER)
  !
  ...
  !
    CALL OL_DEFINE_DIM(UG, U%NSIZE_FULL, HPROGRAM, KLUOUT, INI, &
                       ...
                       .FALSE., KNSNLAYER=GRM%NPE%AL(1)%TSNOW%NLAYER)
    !
