...
!
 CHARACTER(LEN=200), DIMENSION(17) :: XNETCDF_FILENAME_IN= &
                                       (/'PARAMS.nc                  ',&
                                         'FORCING.nc                 ',&
                                         'Forc_TA.nc                 ',&
                                         'Forc_QA.nc                 ',&
...
! M. Lafaysse :
! Output files (ISBA_DIAGNOSTICS or ISBA_PROGNOSTIC) must NOT be put in XNETCDF_FILENAME_IN
! because the opening of these files before the call to NF90_CREATE generate a crash with netcdf4 format.
