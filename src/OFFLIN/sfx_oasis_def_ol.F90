...
!#########
SUBROUTINE SFX_OASIS_DEF_OL (IO, U, UG, HPROGRAM,HALG_MPI)
!#############################################
!
...
!               -------------------------------------------------
!
CALL SFX_OASIS_DEFINE(IO, U, UG, HPROGRAM,INPTS,IPARAL)
!
DEALLOCATE(IPARAL)
!
!-------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
!
IF (LHOOK) CALL DR_HOOK('SFX_OASIS_DEF_OL',1,ZHOOK_HANDLE)
!
!-------------------------------------------------------------------------------
!
