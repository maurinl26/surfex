...
!
REAL, DIMENSION(SIZE(PEK%XTG,1))                 :: ZRESP_HETERO_LITTER ! litter heterotrophic respiration (gC/m2/s)
REAL, DIMENSION(SIZE(PEK%XTG,1))                 :: ZRESP_HETERO_SOIL   ! soil heterotrophic respiration (gC/m2/s)
!
REAL, DIMENSION(SIZE(PEK%XTG,1))                 :: ZCONTROL_SAND   ! control in soil texture (linear function of sand content) 
!
...
!
REAL, DIMENSION(SIZE(PEK%XTG,1),IO%NNSOILCARB)   :: ZSOILCARBON_INPUT ! quantity of carbon going into carbon pools 
!                                                                       from litter decomposition (gC/m2/s)
!
REAL, DIMENSION(SIZE(PEK%XTG,1),IO%NNLITTLEVS)   :: ZCONTROL_MOIST, & ! moisture control of heterotrophic respiration
...
INL=SIZE(PEK%XTG,2)
!
INBIOMASS =IO%NNBIOMASS
INSOILCARB=IO%NNSOILCARB
!
