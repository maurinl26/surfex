...
!!      M.Leriche & V. Masson 05/2016 move open namelist for reading ascii chemi.file
!!      M.Minvielle           12/2023 XDELTA_LEGAL_TIME must be allocated in all cases
!!-----------------------------------------------------------------------------
!
!*       0.    DECLARATIONS
!
...
ELSE
  ALLOCATE(CHN%XDELTA_LEGAL_TIME(0))
END IF
!
IF (HPROGRAM=="NC    ") THEN
