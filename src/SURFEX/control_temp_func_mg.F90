...
!!      B. Decharme 05/2024 : methanogenesis stop below 0°C and not 3°C
!!      
!-------------------------------------------------------------------------------
...
!
REAL, PARAMETER                 :: ZTSUP   = 1.0 ! Limit to produce methanogenesis in °C
REAL, PARAMETER                 :: ZTINF   = 0.0 ! Limit to produce methanogenesis in °C
!
