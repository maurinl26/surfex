...
!     #########
SUBROUTINE COTWORES(PTSTEP, IO, OSHADE, PK, PEK, PPOI, PCSP,                      &
...
!!      C. Delire    01/2014 : vertical profile of dark respiration for tropical forest 
...
REAL,DIMENSION(:),    INTENT(OUT)   :: PRS, PGPP
