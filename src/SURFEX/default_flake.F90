...
!     #########
      SUBROUTINE DEFAULT_FLAKE(PTSTEP,POUT_TSTEP,OSEDIMENTS,HFLK_SNOW, &
        HFLK_FLUX,HFLK_ALB,OSKINTEMP,HFLK_CTMIN,PCTROCMAX)  
!     ########################################################################
!
...
!!      P. Le Moigne 01/2025: rename HSNOW_FLK in HFLK_SNOW
...
CHARACTER(LEN=3), INTENT(OUT) :: HFLK_SNOW
CHARACTER(LEN=5), INTENT(OUT) :: HFLK_FLUX
CHARACTER(LEN=5), INTENT(OUT) :: HFLK_CTMIN
CHARACTER(LEN=4), INTENT(OUT) :: HFLK_ALB
REAL,             INTENT(OUT) :: PCTROCMAX 
