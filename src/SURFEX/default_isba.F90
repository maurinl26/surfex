...
!!    -------------
!!      Original    01/2004 
!!      B.Decharme   04/2013 : delete HTOPREG (never used); water table / surface coupling 
...
!!      B. Decharme     2023 : CHORT='CM6' -> Tuning for CNRM-CM/ESM to reduce the too earlier 
...
!                                          ! 'DRY' = dry Cp
!                                          ! 'HUM' = Cp fct of qs
CHARACTER(LEN=3), INTENT(OUT) :: HZ0HEAT   ! Roughness length for heat
!                                          ! 'DEF' = constant ratio with Z0
!                                          ! 'Z95' = function of u*
REAL,              INTENT(OUT) :: PCGMAX   ! maximum soil heat capacity
!
REAL,              INTENT(OUT) :: PCDRAG   ! drag coefficient in canopy
!
REAL,              INTENT(OUT) :: PZ0HEAT  ! roughness length for heat
!
...
!
CHARACTER(LEN=4), INTENT(OUT) :: HNITRO_DILU ! nitrogen dilution fct of CO2
                                             ! 'NONE' = default
...
!
LOGICAL, INTENT(OUT)          :: OLULCC_MANAGE ! Land-use Land cover change managing
!
