...
!     #########
      SUBROUTINE DEFAULT_TEB_VEG(HRUNOFF, HSCOND,                               &
                                 ...
                                 HCPSURF, HZ0HEAT, PCGMAX, HKSAT, HRAIN, HHORT, &
                                 OGLACIER, OCANOPY_DRAG, OVEGUPD,               &
                                 HNITRO_DILU, PCNLIM, ODOWNREGU                 )
!     ########################################################################
!
...
CHARACTER(LEN=3),  INTENT(OUT) :: HZ0HEAT    ! roughness length for heat ('DEF','Z95')
...
CHARACTER(LEN=3),  INTENT(OUT) :: HHORT      ! Horton runoff ('DEF','SGH','CM6')
CHARACTER(LEN=4),  INTENT(OUT) :: HNITRO_DILU ! nitrogen dilution fct of CO2 ('NONE','CA08','ESM2')
!
