...
SUBROUTINE FLAG_DIAG_UPDATE (FM, IM, SM, TM, WM, DGO, U, SV, &
                             ...
                             OWATER_PROFILE, OSEDIM_PROFILE, OSURF_EVAP_BUDGET, OFLOOD,     &
                             OPGD_ISBA, OCH_NO_FLUX_ISBA, OSURF_MISC_BUDGET_ISBA, OPGD_TEB, &
                             OSURF_MISC_BUDGET_TEB, OLUTILES_BUDGET, OFLKFLUX, OFLKWATER,   &
                             OCROCO                                                         )
!     ############################################################
!
...
!!      R. Seferian  08/2016 : add land use diag key
!!      B. Cluzet    02/2018 : add snow diag. variables
...
LOGICAL, INTENT(IN) :: OSEDIM_PROFILE
...
LOGICAL, INTENT(IN) :: OFLKFLUX
LOGICAL, INTENT(IN) :: OFLKWATER
LOGICAL, INTENT(IN) :: OCROCO !B. Cluzet activate/deactivate diag SPEC_ALB into prep/surfout
!
...
IF (U%CWATER =='FLAKE ') CALL FLAG_FLAKE_UPDATE(KBEQ, OWATER_PROFILE, OSEDIM_PROFILE, OFLKFLUX, &
                                                OFLKWATER,DGO%LSURF_BUDGETC, DGO%LRAD_BUDGET, K2M)
...
IF (U%CNATURE=='ISBA  ') CALL FLAG_ISBA_UPDATE(KBEQ, KDSTEQ, OSURF_EVAP_BUDGET, OFLOOD,         &
                                    OPGD_ISBA, OCROCO, OCH_NO_FLUX_ISBA, OSURF_MISC_BUDGET_ISBA,&
...
!
SUBROUTINE FLAG_FLAKE_UPDATE(KBEQ,OWATER_PROFILE,OSEDIM_PROFILE,OFLKFLUX,OFLKWATER,OSURF_BUDGETC,ORAD_BUDGET,K2M)
!
!
IMPLICIT NONE
!
...
FM%DMF%LSEDIM_PROFILE = OSEDIM_PROFILE
FM%DMF%LFLKFLUX = OFLKFLUX
FM%DMF%LFLKWATER = OFLKWATER
...
SUBROUTINE FLAG_ISBA_UPDATE(KBEQ, KDSTEQ, OSURF_EVAP_BUDGET, OFLOOD,        &
                            OPGD, OCROCO, OCH_NO_FLUX, OSURF_MISC_BUDGET,   &
