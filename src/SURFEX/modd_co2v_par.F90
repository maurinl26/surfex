...
!!      B. Decharme    2023  : coef XAMAX sets to old default value for NE 
!!
!-------------------------------------------------------------------------------
!
!*       0.     DECLARATIONS
...
REAL, PARAMETER, DIMENSION(NVEGTYPE_OLD) :: XAMAX   = (/1.00,    & ! NVT_NO
                                                        ...
                                                        1.00,    & ! NVT_SNOW
                                                        1.30E-6, & ! NVT_TEBD
                                                        2.20E-6, & ! NVT_BONE (cm6 via TRY value 1.40E-6)
                                                        ...
                                                        0.90E-6, & ! NVT_TRBD
                                                        1.30E-6, & ! NVT_TEBE
                                                        2.20E-6, & ! NVT_TENE (cm6 via TRY value 1.40E-6)
                                                        1.30E-6, & ! NVT_BOBD
                                                        2.20E-6, & ! NVT_BOND (cm6 via TRY value 0.90E-6)
                                                        1.70E-6, & ! NVT_BOGR
                                                        1.20E-6 /) ! NVT_SHRB
!                           
