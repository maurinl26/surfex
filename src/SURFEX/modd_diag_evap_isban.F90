...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XLE_FLOOD     ! latent heat of Floodplains evaporation                      (W/m2)
  REAL, POINTER, DIMENSION(:)   :: XLEI_FLOOD    ! latent heat of Floodplains evaporation                      (W/m2)
!
  REAL, POINTER, DIMENSION(:)   :: XEPOT         ! potential evaporation   (kg/m2/s)
!
...
!
  REAL, POINTER, DIMENSION(:)   :: XGNDF         ! soil/snow interface heat flux [W/m2]
!
...
!
! Crocus Snowpappus diagnostics
!
  REAL, POINTER, DIMENSION(:)   :: XQDEP_TOT      ! total wind-blown snow net deposition rate (Crocus/Pappus)     (kg/m2/s)
  REAL, POINTER, DIMENSION(:)   :: XQ_OUT_SUBL    ! transport rate of sublimation                                 (kg/m2/s)
  REAL, POINTER, DIMENSION(:)   :: XQT_TOT        ! total wind-blown snow transport rate (Crocus/Pappus)          (kg/m/s)
  REAL, POINTER, DIMENSION(:)   :: XSNOWDEBTC     ! cumulated total SWE not eroded because the point was snowless (kg/m2)
  REAL, POINTER, DIMENSION(:)   :: XBLOWSNWFLUXINT! total wind-blown snow transport rate between 0.2 and 1.2 m    (kg/m/s)
  REAL, POINTER, DIMENSION(:)   :: XBLOWSNWFLUX_1M! wind-blown snow transport rate between at 1 m                 (kg/m2/s)
!
! Not Clear: initialisation is different for those two following diagnostics: TO BE CHECKED
!
...
!
! Not Clear: those three following diagnostics are often mixed with MEB: TO BE CHECKED
!
...
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XDRIPLIT      ! MEB: TO BE DOCUMENTED
  REAL, POINTER, DIMENSION(:)   :: XRRLIT        ! MEB: TO BE DOCUMENTED
!
  ...
  REAL, POINTER, DIMENSION(:)   :: XUNLOAD       ! MEB: snow unloading from the overstory snow reservoir [kg/m2/s]
...
!
! Snowfree diagnostics: Definition and units should appear here: TO BE DOCUMENTED
!
...
!
NULLIFY(DE%XSYTMASS)
NULLIFY(DE%XQDEP_TOT)
NULLIFY(DE%XQ_OUT_SUBL)
NULLIFY(DE%XQT_TOT)
NULLIFY(DE%XSNOWDEBTC)
NULLIFY(DE%XBLOWSNWFLUXINT)
NULLIFY(DE%XBLOWSNWFLUX_1M)
!
NULLIFY(DE%XUSTAR)
NULLIFY(DE%XMELTADV)
!
