...
!!      P. Le Moigne 01/2025 add C_T_min2=0.65 (Salgado and Le Moigne 2010)
!!      P. Le Moigne 01/2025 add dC_T_dt_max=0.01/3600. (Salgado and Le Moigne 2010)
!!
!==============================================================================
!
! Declarations:
...
REAL, PARAMETER ::         &
    dC_T_dt_max   = 0.01/3600.      ,  &! Maximum C_T rate of change
    C_T_min       = 0.5             ,  &! Minimum value of the shape factor C_T (thermocline)
    C_T_min2      = 0.65            ,  &! Minimum value of the shape factor C_T (thermocline) 
                                        ! according to Salgado and Le Moigne 2010
