...
!
  ...
  CHARACTER(LEN=3)   :: CFLK_SNOW   ! FLake snow scheme
  CHARACTER(LEN=5)   :: CFLK_FLUX   ! Type of flux computation
  CHARACTER(LEN=4)   :: CFLK_ALB    ! Type of albedo
  CHARACTER(LEN=5)   :: CFLK_CTMIN  ! Option for C_T_min value
  REAL               :: XCTROCMAX   ! Maximum value for the Ct Rate Of Change
  REAL               :: XCTMIN      ! Minimum value for Ct
!
!-------------------------------------------------------------------------------------
