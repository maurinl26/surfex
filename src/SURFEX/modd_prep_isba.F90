...
INTEGER, PARAMETER :: NGROUND_LAYERMAX = 20
!
CHARACTER(LEN=28), DIMENSION(NVEGTYPE_MAX,NGROUND_LAYERMAX) :: CFILE_HUG_SOIL ! input file name for Wg, Wgi
CHARACTER(LEN=28), DIMENSION(NVEGTYPE_MAX,NGROUND_LAYERMAX) :: CFILE_TG_SOIL  ! input file name for Tg
!
REAL, DIMENSION(NGROUND_LAYERMAX) :: XUNIF_HUG_SOIL   ! uniform soil wetness index profile
REAL, DIMENSION(NGROUND_LAYERMAX) :: XUNIF_HUGI_SOIL  ! uniform soil porosity profile
REAL, DIMENSION(NGROUND_LAYERMAX) :: XUNIF_TG_SOIL    ! uniform soil temperature profile
!
...
REAL, DIMENSION(:),   POINTER :: XMMPSNOW
