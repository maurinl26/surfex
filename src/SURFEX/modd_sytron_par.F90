...
!     parameters related to the snow redistribution scheme Sytron 
!
!!
!!**  IMPLICIT ARGUMENTS
!!    ------------------
...
REAL, PARAMETER, DIMENSION(2)      :: XSLOPE_SYT = (/20.,40./)  ! List of slope where snow redistribution must be computed (in degree) 
