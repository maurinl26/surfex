...
ALLOCATE(DA%XEVAP     (KLUAC))
ALLOCATE(DA%XSUBL     (KLUAC))
!
...
ALLOCATE(DA%XWIFF_MEAN    (KLUA))
ALLOCATE(DA%XWIDD_MEAN    (KLUA))
!
IF (KLUA>0) THEN
  DA%XRI      = XUNDEF
  DA%XARES    = XUNDEF
...
DEA%XQT_TOT         = 0.0
DEA%XSNOWDEBTC      = 0.0
DEA%XBLOWSNWFLUXINT = 0.0
DEA%XBLOWSNWFLUX_1M = 0.0
!
! Not Clear: often with MEB
DEA%XSWNET_N    = 0.0
DEA%XSWNET_NS   = 0.0
DEA%XLWNET_N    = 0.0
!
...
!-------------------------------------------------------------------------------------
!
SUBROUTINE INIT_PRECIP_BUD(DEA)
!
TYPE(DIAG_EVAP_ISBA_t), INTENT(INOUT) :: DEA
REAL(KIND=JPRB) :: ZHOOK_HANDLE
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:INIT_PRECIP_BUD',0,ZHOOK_HANDLE)
!
DEA%XRAINFALL = 0.0
DEA%XSNOWFALL = 0.0
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:INIT_PRECIP_BUD',1,ZHOOK_HANDLE)
!
END SUBROUTINE INIT_PRECIP_BUD
!
!-------------------------------------------------------------------------------------
!
...
DEA%XLE_FLOOD (:) = DEAC%XLE_FLOOD (:)/PTSTEP
DEA%XLEI_FLOOD(:) = DEAC%XLEI_FLOOD(:)/PTSTEP
!
...
!
DEA%XIFLOOD    (:) = DEAC%XIFLOOD    (:)/PTSTEP
DEA%XPFLOOD    (:) = DEAC%XPFLOOD    (:)/PTSTEP
DEA%XICEFLUX   (:) = DEAC%XICEFLUX   (:)/PTSTEP
DEA%XDRIP      (:) = DEAC%XDRIP      (:)/PTSTEP
DEA%XIRRIG_FLUX(:) = DEAC%XIRRIG_FLUX(:)/PTSTEP
!
DEA%XGNDF      (:) = DEAC%XGNDF      (:)/PTSTEP
!
DEA%XSNFREE_SWU(:) = DEAC%XSNFREE_SWU(:)/PTSTEP
!
! Not clear: often with MEB
DEA%XSWNET_N  (:) = DEAC%XSWNET_N  (:)/PTSTEP
DEA%XSWNET_NS (:) = DEAC%XSWNET_NS (:)/PTSTEP
DEA%XLWNET_N  (:) = DEAC%XLWNET_N  (:)/PTSTEP
!
! Crocus Sytron
DEA%XSYTMASS   (:) = DEAC%XSYTMASS   (:)/PTSTEP
!
! Crocus Snowpappus
DEA%XQDEP_TOT  (:) = DEAC%XQDEP_TOT  (:)/PTSTEP
DEA%XQ_OUT_SUBL(:) = DEAC%XQ_OUT_SUBL(:)/PTSTEP
DEA%XQT_TOT    (:) = DEAC%XQT_TOT    (:)/PTSTEP
DEA%XSNOWDEBTC (:) = DEAC%XSNOWDEBTC (:)/PTSTEP
DEA%XBLOWSNWFLUXINT(:) = DEAC%XBLOWSNWFLUXINT(:)/PTSTEP
DEA%XBLOWSNWFLUX_1M(:) = DEAC%XBLOWSNWFLUX_1M(:)/PTSTEP
!
...
!-------------------------------------------------------------------------------------
!
SUBROUTINE AVG_DIAG_TSTEP_PRECIP(PTSTEP, DEAC, DEA)
!
REAL, INTENT(IN) :: PTSTEP
TYPE(DIAG_EVAP_ISBA_t), INTENT(IN) :: DEAC
TYPE(DIAG_EVAP_ISBA_t), INTENT(INOUT) :: DEA
REAL(KIND=JPRB) :: ZHOOK_HANDLE
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:AVG_DIAG_TSTEP_PRECIP',0,ZHOOK_HANDLE)
!
DEA%XRAINFALL(:) = DEAC%XRAINFALL(:)/PTSTEP
DEA%XSNOWFALL(:) = DEAC%XSNOWFALL(:)/PTSTEP
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:AVG_DIAG_TSTEP_PRECIP',1,ZHOOK_HANDLE)
!
END SUBROUTINE AVG_DIAG_TSTEP_PRECIP
!
!-------------------------------------------------------------------------------------
!
...
!-------------------------------------------------------------------------------------
!
SUBROUTINE AVG_DIAG_TSTEP_MEB(PTSTEP, DEAC, DEA)
!
REAL, INTENT(IN) :: PTSTEP
TYPE(DIAG_EVAP_ISBA_t), INTENT(IN) :: DEAC
TYPE(DIAG_EVAP_ISBA_t), INTENT(INOUT) :: DEA
REAL(KIND=JPRB) :: ZHOOK_HANDLE
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:AVG_DIAG_TSTEP_MEB',0,ZHOOK_HANDLE)
!
DEA%XLELITTER (:) = DEAC%XLELITTER (:)/PTSTEP
DEA%XLELITTERI(:) = DEAC%XLELITTERI(:)/PTSTEP
DEA%XDRIPLIT  (:) = DEAC%XDRIPLIT  (:)/PTSTEP
DEA%XRRLIT    (:) = DEAC%XRRLIT    (:)/PTSTEP
!
DEA%XLEV_CV   (:) = DEAC%XLEV_CV   (:)/PTSTEP
DEA%XLES_CV   (:) = DEAC%XLES_CV   (:)/PTSTEP
DEA%XLETR_CV  (:) = DEAC%XLETR_CV  (:)/PTSTEP
DEA%XLER_CV   (:) = DEAC%XLER_CV   (:)/PTSTEP
DEA%XLE_CV    (:) = DEAC%XLE_CV    (:)/PTSTEP
DEA%XH_CV     (:) = DEAC%XH_CV     (:)/PTSTEP
DEA%XMELT_CV  (:) = DEAC%XMELT_CV  (:)/PTSTEP
DEA%XUNLOAD   (:) = DEAC%XUNLOAD   (:)/PTSTEP
DEA%XFRZ_CV   (:) = DEAC%XFRZ_CV   (:)/PTSTEP
!
DEA%XLETR_GV  (:) = DEAC%XLETR_GV  (:)/PTSTEP
DEA%XLER_GV   (:) = DEAC%XLER_GV   (:)/PTSTEP
DEA%XLE_GV    (:) = DEAC%XLE_GV    (:)/PTSTEP
DEA%XH_GV     (:) = DEAC%XH_GV     (:)/PTSTEP
!
DEA%XLE_GN    (:) = DEAC%XLE_GN    (:)/PTSTEP
DEA%XEVAP_GN  (:) = DEAC%XEVAP_GN  (:)/PTSTEP  ! CHECK: DIAG NOT WRITTEN
DEA%XH_GN     (:) = DEAC%XH_GN     (:)/PTSTEP
DEA%XSR_GN    (:) = DEAC%XSR_GN    (:)/PTSTEP
DEA%XSWDOWN_GN(:) = DEAC%XSWDOWN_GN(:)/PTSTEP
DEA%XLWDOWN_GN(:) = DEAC%XLWDOWN_GN(:)/PTSTEP
!
DEA%XEVAP_G   (:) = DEAC%XEVAP_G   (:)/PTSTEP  ! CHECK: DIAG NOT WRITTEN
DEA%XLE_CA    (:) = DEAC%XLE_CA    (:)/PTSTEP
DEA%XH_CA     (:) = DEAC%XH_CA     (:)/PTSTEP
!
DEA%XSWNET_V  (:) = DEAC%XSWNET_V  (:)/PTSTEP
DEA%XSWNET_G  (:) = DEAC%XSWNET_G  (:)/PTSTEP
DEA%XLWNET_V  (:) = DEAC%XLWNET_V  (:)/PTSTEP
DEA%XLWNET_G  (:) = DEAC%XLWNET_G  (:)/PTSTEP
!
IF (LHOOK) CALL DR_HOOK('MODE_DIAG:AVG_DIAG_TSTEP_MEB',1,ZHOOK_HANDLE)
!
END SUBROUTINE AVG_DIAG_TSTEP_MEB
!
!-------------------------------------------------------------------------------
!
