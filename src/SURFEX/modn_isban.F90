...
!!    -------------
!!      Original    01/2004
!!      B. Decharme        08/2009 : LSURF_BUDGETC for all tiles
...
LOGICAL  :: LGLACIER
LOGICAL  :: LVEGUPD
CHARACTER(4) :: CNITRO_DILU
LOGICAL  :: LDOWNREGU
LOGICAL  :: LLULCC_MANAGE
LOGICAL  :: LFIRE
LOGICAL  :: LCLEACH
LOGICAL  :: LADVECT_SOC
LOGICAL  :: LCRYOTURB
...
LOGICAL  :: LSNOWSYTRON
LOGICAL  :: LSNOWPAPPUS !Pappus snow transport scheme
CHARACTER(3):: CSNOWPAPPUSERODEPO
CHARACTER(3):: CSALTPAPPUS
CHARACTER(4)::CSNOWFPAPPUS
CHARACTER(4):: CPAPPUSSUBLI
CHARACTER(4)::CLIMVFALL
LOGICAL  :: LPAPPULIMTFLUX
LOGICAL  :: LPAPPUDEBUG
LOGICAL  :: LATMORAD
CHARACTER(3) :: CSNOWMETAMO
CHARACTER(4) :: CSNOWMOB
...
INTEGER  :: XFREQ_GRO
!
REAL, DIMENSION(1000)      :: XPROD_SCHEME
LOGICAL, DIMENSION(9500):: LPRODSNOWMAK
REAL, DIMENSION(4)      :: XSM_END
! New options Lafaysse et al. 2017
...
NAMELIST/NAM_ISBAn/CC1DRY,CSCOND,CSOILFRZ,CDIFSFCOND,CSNOWRES,CCPSURF,CZ0HEAT,  &
                   XTSTEP,XCVHEATF,XCGMAX,XCDRAG,XZ0HEAT,LGLACIER,LCANOPY_DRAG, &
                   LVEGUPD,LPERTSURF
!
...
NAMELIST/NAM_ISBA_SNOWn/CSNOWDRIFT,LSNOWDRIFT_SUBLIM, LSNOW_ABS_ZENITH,&
                        CSNOWMETAMO, CSNOWMOB,CSNOWRAD,LATMORAD,       &
                        LSNOWSYTRON, CSNOWFALL, CSNOWCOND, CSNOWHOLD,  &
                        CSNOWCOMP, CSNOWZREF, LSNOWCOMPACT_BOOL,       &
                        LSNOWMAK_BOOL, LPRODSNOWMAK, LSNOWMAK_PROP,    &
                        LSNOWTILLER, LSELF_PROD, LSNOWPAPPUS,          &
                        CSNOWPAPPUSERODEPO,CSNOWFPAPPUS,CPAPPUSSUBLI,  &
                        CSALTPAPPUS,CLIMVFALL, LPAPPULIMTFLUX,         &
                        LPAPPUDEBUG
!
...
!
  ...
  LLULCC_MANAGE= IO%LLULCC_MANAGE
  LFIRE        = IO%LFIRE
  LCLEACH      = IO%LCLEACH
...
!
  ...
  IO%LLULCC_MANAGE= LLULCC_MANAGE
  IO%LFIRE        = LFIRE
  IO%LCLEACH      = LCLEACH
...
!Snowdrift option
  LSNOWPAPPUS = IO%LSNOWPAPPUS
  CSNOWPAPPUSERODEPO = IO%CSNOWPAPPUSERODEPO
  CPAPPUSSUBLI = IO%CPAPPUSSUBLI
  CSALTPAPPUS = IO%CSALTPAPPUS
  CSNOWFPAPPUS = IO%CSNOWFPAPPUS
  CLIMVFALL = IO%CLIMVFALL
  LPAPPULIMTFLUX = IO%LPAPPULIMTFLUX
  LPAPPUDEBUG = IO%LPAPPUDEBUG
...
!Snowdrift option
  IO%LSNOWPAPPUS = LSNOWPAPPUS
  IO%CSNOWPAPPUSERODEPO = CSNOWPAPPUSERODEPO
  IO%CPAPPUSSUBLI = CPAPPUSSUBLI
  IO%CSALTPAPPUS = CSALTPAPPUS
  IO%CSNOWFPAPPUS = CSNOWFPAPPUS
  IO%LPAPPULIMTFLUX = LPAPPULIMTFLUX
  IO%LPAPPUDEBUG = LPAPPUDEBUG
  IO%CLIMVFALL = CLIMVFALL
  IF (LHOOK) CALL DR_HOOK('MODN_ISBA_N:INIT_NAM_ISBA_SNOWn',1,ZHOOK_HANDLE)
!
