...
!!    L. Hardouin 05/2013 Reregression is done only for topographic index resolution of 1km (30arcs)
!!
!----------------------------------------------------------------------------
!
!*    0.     DECLARATION
...
!             ----------------------------
!
!    Reregression is done only for resolution of 1km (30arcs)
!
...
!
!        1km to 10m
         WRITE(ILUOUT,*)' PAN AND KING (2012) 1km to 10m then to 2m '
...
!            ------------------------
!
LOGICAL,           INTENT(OUT) :: OREG        ! regression key
!
!*    0.2    Declaration of local variables
!            ------------------------------
!
...
!
Z1000M = 8.3E-3 !(minute arc to m)
!
IF(SQRT(ZDLAT*ZDLON) >= Z1000M)THEN
   OREG =.TRUE.
ENDIF
!
!
