...
!!      P Le Moigne  08/2023  Initialization of MEB from external file
!!
!!------------------------------------------------------------------
!
...
USE MODD_PREP_ISBA,        ONLY : XGRID_SOIL, XWR_DEF, XQC_DEF, XWRV_DEF, XWRVN_DEF
...
!* reading surface temperature
     ...
     CALL READ_EXTERN_ISBA(U, DTCO, GCP, IO, NPAR_VEG_IRR_USE,    &
                           HFILE,HFILETYPE,HFILEPGD,HFILEPGDTYPE, &
                           KLUOUT,INI,YRECFM,YRECFM,ZFIELD,ZD,OKEY)
! 
    IF (INI>0) THEN
