...
!     #########
      SUBROUTINE READ_NAM_PGD_ISBA(HPROGRAM, KPATCH, KGROUND_LAYER, KSAND_LAYER, KCLAY_LAYER, &
                                   HISBA, HPEDOTF, HPHOTO, HGNDRES,                           &
                                   OTR_ML, HALBEDO, PRM_PATCH,                                &
...
!!
!!    Original    01/2005
!!    B. Decharme     07/2008 : uniform value of subgrid drainage coefficient
!!    E. Martin       12/2008 : files of data for subgrid drainage and subgridrunoff
...
!!    B. Decharme     10/2106 : bug surface/groundwater coupling 
!!    R. Séférian     08/2016 : landuse key 
...
INTEGER,             INTENT(OUT)   :: KSAND_LAYER   ! number of sand layers
INTEGER,             INTENT(OUT)   :: KCLAY_LAYER   ! number of clay layers
...
CHARACTER(LEN=3),    INTENT(OUT)   :: HGNDRES       ! baresoil evap resistance options
...
CHARACTER(LEN=28), DIMENSION(20), INTENT(OUT)   :: HSAND    ! file name for sand fractions
CHARACTER(LEN=28), DIMENSION(20), INTENT(OUT)   :: HCLAY    ! file name for clay fractions
...
CHARACTER(LEN=3)         :: CGNDRES          ! baresoil evap resistance options
...
CHARACTER(LEN=28), DIMENSION(20)  :: YSAND  ! file name for sand fractions
CHARACTER(LEN=28), DIMENSION(20)  :: YCLAY  ! file name for clay fractions
...
!
NAMELIST/NAM_ISBA/ NPATCH, NGROUND_LAYER, NSAND_LAYER, NCLAY_LAYER, CISBA, &
                   CPEDO_FUNCTION, CPHOTO, CGNDRES,                        &
                   LTR_ML, CALBEDO, XRM_PATCH,                             &
...
KSAND_LAYER      = NSAND_LAYER      ! number of sand layers
KCLAY_LAYER      = NCLAY_LAYER      ! number of clay layers
...
HGNDRES          = CGNDRES          ! baresoil evap resistance options
