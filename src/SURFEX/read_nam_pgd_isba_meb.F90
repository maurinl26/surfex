...
!     #########
      SUBROUTINE READ_NAM_PGD_ISBA_MEB(HPROGRAM, KLUOUT, OMEB_PATCH, OFORC_MEASURE, &
                      OMEB_LITTER, HMEB_GNDRES, OMEB_TALL_VEG, OMEB_INT_PLUN,       &
                      OMEB_INT_ULUN, OMEB_INT_USFC)  
!     #############################################################################
!
...
LOGICAL              , INTENT(OUT) :: OMEB_TALL_VEG
LOGICAL              , INTENT(OUT) :: OMEB_INT_PLUN
LOGICAL              , INTENT(OUT) :: OMEB_INT_ULUN
LOGICAL              , INTENT(OUT) :: OMEB_INT_USFC
CHARACTER(LEN=3)     , INTENT(OUT) :: HMEB_GNDRES
!
...
LOGICAL                :: LMEB_LITTER
LOGICAL                :: LMEB_TALL_VEG
LOGICAL                :: LMEB_INT_PLUN
LOGICAL                :: LMEB_INT_ULUN
LOGICAL                :: LMEB_INT_USFC
CHARACTER(LEN=3)       :: CMEB_GNDRES
!
REAL(KIND=JPRB) :: ZHOOK_HANDLE
!
NAMELIST/NAM_MEB_ISBA/LMEB_PATCH,LFORC_MEASURE,LMEB_LITTER,CMEB_GNDRES,LMEB_TALL_VEG,LMEB_INT_PLUN,&
                      LMEB_INT_ULUN,LMEB_INT_USFC
!
!-------------------------------------------------------------------------------
!
...
OMEB_TALL_VEG = LMEB_TALL_VEG
OMEB_INT_PLUN = LMEB_INT_PLUN
OMEB_INT_ULUN = LMEB_INT_ULUN
OMEB_INT_USFC = LMEB_INT_USFC
HMEB_GNDRES   = CMEB_GNDRES
!
!
