...
!     #######################################################
!
!!****  *READ_NAM_PREP_ISBA_n* - read ISBA namelists for initialization
!!
!!    PURPOSE
!!    -------
!
...
CALL TEST_NAM_VAR_SURF(ILUOUT,'CTYPEPGD', CTYPEPGD, '      ','GRIB  ','MESONH','ASCII ','LFI   ','FA    ','NC    ')
...
!
CALL READ_PREP_ISBA_CARBON(HPROGRAM,CRESPSL,LSOILGAS)
!
