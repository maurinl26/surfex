...
!     #######################################################
!
!!****  *READ_NAMELISTS_FLAKE_n* - routine to read namelists for FLake model
!!
!!    PURPOSE
!!    -------
!!
...
IF (LHOOK) CALL DR_HOOK('READ_NAMELISTS_FLAKE_N',0,ZHOOK_HANDLE)
 CALL DEFAULT_FLAKE(XTSTEP,XOUT_TSTEP,LSEDIMENTS,CFLK_SNOW,CFLK_FLUX,CFLK_ALB,&
                   LSKINTEMP,CFLK_CTMIN,XCTROCMAX)
!
...
!
 CALL DEFAULT_DIAG_FLAKE(N2M,LSURF_BUDGET,L2M_MIN_ZS,LRAD_BUDGET,LCOEF,LSURF_VARS,     &
                         ...
                         XZWAT_PROFILE,XZSED_PROFILE,LSEDIM_PROFILE,LFLKFLUX,LFLKWATER )  
!
