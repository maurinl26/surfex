...
!     #######################################################
!
!!****  *READ_PRE_SEAF_DAT_CONF* - routine to read the date in namelist
!!
!!    PURPOSE
!!    -------
!!
...
IF (LHOOK) CALL DR_HOOK('READ_PRE_SEAF_DAT_CONF',0,ZHOOK_HANDLE)
TPTIME%TIME       = XTIME
IF (LHOOK) CALL DR_HOOK('READ_PRE_SEAF_DAT_CONF',1,ZHOOK_HANDLE)
!
!
!------------------------------------------------------------------------------
!
