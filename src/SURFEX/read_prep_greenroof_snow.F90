...
REAL, DIMENSION(NSNOW_LAYER_MAX) :: XWSNOW_GR, XZSNOW_GR, XRSNOW_GR, XTSNOW_GR, XLWCSNOW_GR, &
                                    XSG1SNOW_GR, XSG2SNOW_GR, XHISTSNOW_GR, XMMPSNOW_GR, XAGESNOW_GR                                        
REAL, DIMENSION(NSNOW_LAYER_MAX,NIMPUR_MAX) :: XIMPURSNOW_GR
!
LOGICAL           :: LFILE
!
...
NAMELIST/NAM_PREP_ISBA_SNOW/CSNOW, NSNOW_LAYER, CFILE_SNOW, CTYPE_SNOW,  &
                            ...
                            XSG1SNOW, XSG2SNOW, XHISTSNOW, XMMPSNOW, XAGESNOW,     &
...
IF (LNAM_READ) THEN
  ...
  IF (GFOUND) THEN
    ...
    XMMPSNOW_GR = XMMPSNOW
    XAGESNOW_GR(:) = XAGESNOW(:)
    DO JIMP=1,NIMPUR
      XIMPURSNOW_GR(:,JIMP) = XIMPURSNOW(:,JIMP)
    ENDDO
    !
  ENDIF
  !
  ...
  ALLOCATE(XIMPURSNOW_p(NSNOW_LAYER_GR,NIMPUR))
  ...
  XIMPURSNOW_p =XIMPURSNOW_GR(1:NSNOW_LAYER_GR,1:NIMPUR)
