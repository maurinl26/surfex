...
!     ##########################################################################
      SUBROUTINE SNOWCRO(HSNOWRES, TPTIME, OMEB, HIMPLICIT_WIND,      &
                      ...
                      PTSTEP,PPS,PSR,PUNLOAD, PRR,PPSN3L,                       &
                      ...
                      OSELF_PROD, OSNOWMAK_PROP, PVFRIC_T )
...
!
REAL, DIMENSION(:), INTENT(IN)         :: PPS, PTA, PSW_RAD, PQA, PVMOD, PLW_RAD, PSR, PUNLOAD, PRR
...
ZSNOWDZO(:,:) = PSNOWDZ(:,:)
!
 CALL SNOWNLFALL_UPGRID(PTSTEP,ZSR,PTA,PVMOD,ZSNOWBIS,PSNOWRHO,     &
...
IF (.NOT. OMEB) THEN
  ...
  IF (HSNOWDRIFT  .NE. 'NONE') THEN
    CALL SNOWDRIFT(PTSTEP, PVMOD, PSNOWRHO,PSNOWDZ, ZSNOW, HSNOWMETAMO, HSNOWDRIFT,  &
                   ...
                   PZ0EFF,ZUREF,OSNOWDRIFT_SUBLIM,PSNDRIFT,PVFRIC_T                  )
  END IF
  !***************************************DEBUG IN**********************************************
  IF (GCRODEBUGDETAILSPRINT) THEN
...
SUBROUTINE SNOWDRIFT(PTSTEP,PVMOD,PSNOWRHO,PSNOWDZ,PSNOW,HSNOWMETAMO,HSNOWDRIFT,        &
                     ...
                     OSNOWDRIFT_SUBLIM,PSNDRIFT, PVFRIC_T      )
!
!!    PURPOSE
!!    -------
...
USE MODD_SNOW_PAR, ONLY : XVTIME, XVROMAX, XVROMIN, XVMOB1, XZ0SN,  &
                          XVMOB2, XVMOB3, XVMOB4, XVDRIFT1, XVDRIFT2, XVDRIFT3, &
                          XVSIZEMIN, XCOEF_EFFECT, XQS_REF
USE MODE_SNOW3L, ONLY : GETGRAINSIZE_B21
  ...
  DO JST = 1,IMAX_USE
    IF (JST <= KNLVLS_USE(JJ)) THEN
      ...
      IF ( OSNOWDRIFT_SUBLIM .AND. JST==1 ) THEN
        ...
        ! WRITE(*,*) 'V>Vt DSWE DZ Z:',- MAX(0.,ZQS)*PTSTEP/XCOEF_FF,
        ! - MAX(0.,ZQS)*PTSTEP/XCOEF_FF/PSNOWRHO(JJ,JST),PSNOWDZ(JJ,JST)
      ...
      ZDRIFT_EFFECT(JJ,JST) = ( ZQS_EFFECT + ZWIND_EFFECT ) * PTSTEP/XCROCOEF_FF/XVTIME
