...
USE MODN_IO_OFFLINE,ONLY : LSPECSNOW
!
IMPLICIT NONE
!
...
IF (DGO%N2M>=1) THEN
  ...
  YRECFM='T2MMEA'
  YCOMMENT='X_Y_'//YRECFM//' (K)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XT2M_MEAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='Q2M'
  ...
  !
  YRECFM='Q2MMEA'
  YCOMMENT='W_Y_'//YRECFM//' (KG/KG)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XQ2M_MEAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='HU2M'
  YCOMMENT='X_Y_'//YRECFM//' (-)'
  ...
  YRECFM='HU2MMEA'
  YCOMMENT='X_Y_'//YRECFM//' (-)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XHU2M_MEAN(:),IRESP,HCOMMENT=YCOMMENT)
  !
...
IF (DGO%LSURF_BUDGETC) THEN
  ...
  YRECFM='QFC'
  YCOMMENT='X_Y_'//YRECFM//' (W/m2)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,DC%XQF(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='EVAPC'
...
!
  ...
  !
  YRECFM='RHOA'
  YCOMMENT='X_Y_'//YRECFM//' (kg/m3)'
  CALL WRITE_SURF(DGO%CSELECT,HPROGRAM,YRECFM,D%XRHOA(:),IRESP,HCOMMENT=YCOMMENT)
  !
  YRECFM='PS'
