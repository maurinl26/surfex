...
!
 ...
 CALL WRITE_SURF( YSC%DUO%CSELECT, HPROGRAM,'TOWN_TO_COV',YSC%U%LTOWN_TO_COVER,IRESP,YCOMMENT)
 CALL WRITE_SURF( YSC%DUO%CSELECT, HPROGRAM,'REPLACE_COV',YSC%U%NREPLACE_COVER,IRESP,YCOMMENT)
...
IF (HPROGRAM.NE.'BINARY' .AND. HPROGRAM.NE.'TEXTE ') THEN
   CALL WRITE_ECOCLIMAP2_DATA( YSC%DUO%CSELECT,  HPROGRAM, YSC%U%LECOSG)
ENDIF
!
 CALL WRITE_GRID(YSC%DUO%CSELECT, HPROGRAM,YSC%UG%G%CGRID,YSC%UG%G%XGRID_PAR,&
                 YSC%UG%G%XLAT,YSC%UG%G%XLON,YSC%UG%G%XMESH_SIZE,IRESP,YSC%USS%XZ0EFFJPDIR)
!
...
IF (YSC%U%NDIM_TOWN>0) CALL WRITE_PGD_TOWN_n(YSC%DTCO, YSC%DUO%CSELECT, YSC%U, &
                                             YSC%TM, YSC%GDM, YSC%GRM, YSC%HM, HPROGRAM)
!
!
